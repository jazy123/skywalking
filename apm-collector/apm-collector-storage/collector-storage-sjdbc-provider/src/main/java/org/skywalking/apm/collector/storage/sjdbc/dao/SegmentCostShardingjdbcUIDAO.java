 ...
 * @author linjiaqi
 */
public class SegmentCostShardingjdbcUIDAO extends ShardingjdbcDAO implements ISegmentCostUIDAO {

    private final Logger logger = LoggerFactory.getLogger(SegmentCostShardingjdbcUIDAO.class);
    private static final String GET_SEGMENT_COST_SQL = "select * from {0} where {1} >= ? and {1} <= ?";

    public SegmentCostShardingjdbcUIDAO(ShardingjdbcClient client) {
        super(client);
    }
