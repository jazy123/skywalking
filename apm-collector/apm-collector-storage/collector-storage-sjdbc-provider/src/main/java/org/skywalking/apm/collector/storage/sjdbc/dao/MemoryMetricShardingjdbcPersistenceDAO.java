 ...
 * @author linjiaqi
 */
public class MemoryMetricShardingjdbcPersistenceDAO extends ShardingjdbcDAO implements IMemoryMetricPersistenceDAO<ShardingjdbcSqlEntity, ShardingjdbcSqlEntity, MemoryMetric> {

    public MemoryMetricShardingjdbcPersistenceDAO(ShardingjdbcClient client) {
        super(client);
    }
    ...
    @Override public ShardingjdbcSqlEntity prepareBatchInsert(MemoryMetric data) {
    ...
    @Override public ShardingjdbcSqlEntity prepareBatchUpdate(MemoryMetric data) {
        return null;
    }
}
