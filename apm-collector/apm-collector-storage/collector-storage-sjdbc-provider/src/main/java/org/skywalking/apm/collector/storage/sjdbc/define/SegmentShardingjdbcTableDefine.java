...
public class SegmentShardingjdbcTableDefine extends ShardingjdbcTableDefine {
    ...
    @Override public void initialize() {
        addColumn(new ShardingjdbcColumnDefine(SegmentTable.COLUMN_ID, ShardingjdbcColumnDefine.Type.Varchar.name()));
        addColumn(new ShardingjdbcColumnDefine(SegmentTable.COLUMN_DATA_BINARY, ShardingjdbcColumnDefine.Type.BLOB.name()));
        addColumn(new ShardingjdbcColumnDefine(SegmentTable.COLUMN_TIME_BUCKET, ShardingjdbcColumnDefine.Type.Bigint.name()));
    }
}
